...
<TagCard
  title="技术栈"
  groups={[
    { name: '前端技术', tags: ['Vue.js', 'React', 'TypeScript', 'Astro', 'Nuxt.js', 'Next.js'], color: 'primary' },
    { name: '样式和工具', tags: ['Tailwind CSS', 'Sass', 'Vite', 'Webpack', 'ESLint', 'Prettier'], color: 'secondary' },
    { name: '后端技术', tags: ['Node.js', 'Express', 'MongoDB', 'PostgreSQL', 'Redis'], color: 'accent' }
  ]}
/>
...
<IconCard
  ...
  items={[
    ...
    { icon: 'book', title: '阅读', description: '喜欢阅读技术书籍和科幻小说', color: 'secondary' },
